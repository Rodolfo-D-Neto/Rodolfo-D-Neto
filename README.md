...
*   **Testes e Automação:** Cypress (Testes E2E e UI).
*   **Linguagens:** Python (Foco em scripts lógicos e orientação a objetos).
*   **Banco de Dados:** Consultas avançadas em SQL (DDL, DML, DQL) e validação de integridade.
*   **Fundamentos de QA:** Elaboração de Planos de Teste, Casos de Teste, mapeamento de cenários e versionamento de código (Git/GitHub).
...
### 📫 Contato
*   **LinkedIn:** [https://www.linkedin.com/in/rodolfo-dutra-eqa/]
*   **E-mail:** [rodolfodutraneto@gmail.com]
